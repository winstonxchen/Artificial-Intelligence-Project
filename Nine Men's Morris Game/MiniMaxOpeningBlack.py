...
def MiniMaxOpeningBlack(depth, currBoard, playerW):
...
if __name__ == '__main__':
    ...
    output_board=''
    result = MiniMaxOpeningBlack(depth, input_board,False )
